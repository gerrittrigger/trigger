...
const (
	EventsBatchRefUpdated     = "batch-ref-updated"
	EventsChangeAbandoned     = "change-abandoned"
	EventsChangeDeleted       = "change-deleted"
	EventsChangeMerged        = "change-merged"
	EventsChangeRestored      = "change-restored"
	EventsCommentAdded        = "comment-added"
	EventsCommitReceived      = "commit-received"
	EventsHashtagsChanged     = "hashtags-changed"
	EventsPatchsetCreated     = "patchset-created"
	EventsPrivateStateChanged = "private-state-changed"
	EventsProjectCreated      = "project-created"
	EventsProjectHeadUpdated  = "project-head-updated"
	EventsRefReceived         = "ref-received"
	EventsRefReplicated       = "ref-replicated"
	EventsRefUpdated          = "ref-updated"
	EventsReviewerAdded       = "reviewer-added"
	EventsReviewerDeleted     = "reviewer-deleted"
	EventsTopicChanged        = "topic-changed"
	EventsVoteDeleted         = "vote-deleted"
	EventsWipStateChanged     = "wip-state-changed"
)
